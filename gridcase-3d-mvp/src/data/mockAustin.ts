...
export const mockProjectCatalog: Project[] = [
  ...
  // ── Sunset Valley projects ──────────────────────────────────────────────────
  {
    id: 'p-sunset-solar-microgrid',
    name: 'Sunset Valley Solar Microgrid',
    type: 'community_microgrid',
    zoneId: 'z-sunset-valley',
    nodeId: 'n-sunset-valley-sub',
    capexUSD: 18_000_000,
    effects: { capacityBoostMW: 20, vulnerabilityReduction: 0.25, cascadeResistance: 0.30, recoverySpeedBoost: 0.45 },
    description: 'Islanding-capable solar microgrid with 8-hour battery backup serving 4,500 residential customers in Sunset Valley.',
  },
  {
    id: 'p-sunset-hardening',
    name: 'Sunset Valley Feeder Hardening',
    type: 'grid_hardening',
    zoneId: 'z-sunset-valley',
    nodeId: 'n-sunset-valley-sub',
    capexUSD: 14_000_000,
    effects: { capacityBoostMW: 15, cascadeResistance: 0.35, vulnerabilityReduction: 0.18 },
    description: 'Replaces aging overhead conductors with covered wire and adds automated reclosers to reduce storm-driven outages.',
  },
  {
    id: 'p-sunset-cooling',
    name: 'Sunset Valley Community Cooling Hub',
    type: 'district_hvac',
    zoneId: 'z-sunset-valley',
    capexUSD: 11_000_000,
    effects: { utilityResilienceBoost: 0.55, demandReductionFactor: 0.07 },
    description: 'Shared district cooling facility with backup generation, reducing residential AC load and providing heat-relief shelter during summer emergencies.',
  },

  // ── Mueller utility projects ────────────────────────────────────────────────
  {
    id: 'p-mueller-water-backup',
    name: 'Mueller Water Pump Backup',
    type: 'water_infrastructure',
    zoneId: 'z-mueller',
    capexUSD: 12_000_000,
    effects: { utilityResilienceBoost: 0.50, vulnerabilityReduction: 0.15, recoverySpeedBoost: 0.30, capacityBoostMW: 8 },
    description: 'Battery-backed water pumping stations at Mueller to maintain pressure during grid outages, serving 33,000 residents.',
  },
  {
    id: 'p-mueller-emergency-hvac',
    name: 'Mueller Emergency Cooling Center',
    type: 'district_hvac',
    zoneId: 'z-mueller',
    capexUSD: 13_000_000,
    effects: { utilityResilienceBoost: 0.60, demandReductionFactor: 0.06 },
    description: 'Centralized emergency cooling and heating facility with 48-hour backup power, providing shelter during extreme weather events.',
  },
];
